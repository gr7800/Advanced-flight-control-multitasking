...
const Startgame = () => {
  ...
  useEffect(() => {
    if (minutes < 0) {
      let totalScore = Math.floor((score.airspeedScore + score.altitudeScore + score.headingScore + score.directorScore+score.questionScore) / 5)
      ...
      navigate("/result", {
        state: { totalScore: totalScore, altitudeScore: score.altitudeScore, airspeedScore: score.airspeedScore, headingScore: score.headingScore, directorScore: score.directorScore,questionScore:score.questionScore }
      });
    }
  ...
  return (
    <Box bg="aquamarine" paddingBottom={"20px"} >
      ...
      >
        ...
        {/* ..............Questions ...........  */}
        <Box w={"400px"} height={"430px"} bgImage={BorderImage} bgSize={"cover"} p={"50px"} >
          <QuestionScreen  onScoreChange={handleScoreChange} />
        </Box>
      </Box>
    </Box >
  )
